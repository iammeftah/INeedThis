        ...
        <div className='bg-slate-950 text-neutral-50 w-full h-screen flex flex-col md:flex-row'>
            ...
            {SignUpVisible && (
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    <div className="glass max-w-full w-full sm:w-1/2 flex items-center justify-center">
            ...
            {SignInVisible && (
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    <div className="glass max-w-full w-full sm:w-1/3 px-6 sm:px-2 py-6 flex items-center justify-center">
